...
% l2.m
%
% Model exported on Mar 2 2026, 16:23 by COMSOL 6.1.0.252.
...
model.param('par6').set('l0', '2[mm]', [native2unicode(hex2dec({'88' 'c2'}), 'unicode')  native2unicode(hex2dec({'7e' 'b9'}), 'unicode')  native2unicode(hex2dec({'72' '79'}), 'unicode')  native2unicode(hex2dec({'5f' '81'}), 'unicode')  native2unicode(hex2dec({'5b' 'bd'}), 'unicode')  native2unicode(hex2dec({'5e' 'a6'}), 'unicode') ]);
...
model.component('comp1').view('view1').axis.set('xmin', -7.910057067871094);
model.component('comp1').view('view1').axis.set('xmax', 107.9100570678711);
model.component('comp1').view('view1').axis.set('ymin', -7.134044647216797);
model.component('comp1').view('view1').axis.set('ymax', 107.13404846191406);
...
model.component('comp1').physics('solid').feature('bndl1').set('FollowerPressure', '-Sh');
...
model.component('comp1').physics('solid').feature('bndl2').set('FollowerPressure', '-Sv');
...
model.component('comp1').mesh('mesh1').feature('map1').feature('size1').set('hmax', 'hmax/2');
model.component('comp1').mesh('mesh1').feature('map1').feature('size1').set('hmaxactive', true);
model.component('comp1').mesh('mesh1').feature('map1').feature('size1').set('hmin', 'hmax/2');
...
model.component('comp1').mesh('mesh1').feature('map1').feature('size2').set('hmin', 'hmax/2');
...
model.sol('sol1').feature('v1').set('clist', {'range(0,0.1,6)' '0.006[s]'});
