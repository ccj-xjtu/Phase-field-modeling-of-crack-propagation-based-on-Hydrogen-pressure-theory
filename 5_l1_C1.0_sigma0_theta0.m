...
% l1.m
%
% Model exported on Mar 2 2026, 16:40 by COMSOL 6.1.0.252.
...
model.modelPath(['E:\01' native2unicode(hex2dec({'6c' '22'}), 'unicode')  native2unicode(hex2dec({'81' '06'}), 'unicode') '\' native2unicode(hex2dec({'6a' '21'}), 'unicode')  native2unicode(hex2dec({'57' '8b'}), 'unicode') '\' native2unicode(hex2dec({'7b' '2c'}), 'unicode') '2' native2unicode(hex2dec({'90' 'e8'}), 'unicode')  native2unicode(hex2dec({'52' '06'}), 'unicode') '\01 20mmol' native2unicode(hex2dec({'6a' '21'}), 'unicode')  native2unicode(hex2dec({'57' '8b'}), 'unicode') '\' native2unicode(hex2dec({'56' 'fe'}), 'unicode') ]);
...
model.component('comp1').func('an3').set('expr', 'if(t<0.2,t,if(t<0.4,0.2,if(t<0.6,t-0.2,if(t<0.8,0.4,if(t<1.0,t-0.4,if(t<1.2,0.6,if(t<1.4,t-0.6,if(t<1.6,0.8,if(t<1.8,t-0.8,if(t<2,1,if(t<2.2,t-1,if(t<2.4,1.2,if(t<2.6,t-1.2,if(t<2.8,1.4,if(t<3,t-1.4,if(t<3.2,1.6,if(t<3.4,t-1.6,if(t<3.6,1.8,if(t<3.8,t-1.8,if(t<2,1,2))))))))))))))))))))');
model.component('comp1').func('an3').set('args', {'t'});
model.component('comp1').func('an3').set('argunit', {'s'});
model.component('comp1').func('an3').set('plotargs', {'t' '0' '8'});
...
model.component('comp1').variable('var2').set('n', '10*t1(t)[N/mm]');
model.component('comp1').variable('var2').set('p1', '124.71*n/(V+0.004)');
model.component('comp1').variable('var2').set('V', 'intop1(COE_p(phi))/2+k');
...
model.component('comp1').view('view1').axis.set('xmin', -24.96575164794922);
model.component('comp1').view('view1').axis.set('xmax', 124.96575164794922);
model.component('comp1').view('view1').axis.set('ymin', -20.947486877441406);
model.component('comp1').view('view1').axis.set('ymax', 120.9474868774414);
...
model.component('comp1').physics('solid').feature('disp3').label([native2unicode(hex2dec({'63' '07'}), 'unicode')  native2unicode(hex2dec({'5b' '9a'}), 'unicode')  native2unicode(hex2dec({'4f' '4d'}), 'unicode')  native2unicode(hex2dec({'79' 'fb'}), 'unicode') ' 2']);
...
model.component('comp1').probe('var1').label([native2unicode(hex2dec({'88' 'c2'}), 'unicode')  native2unicode(hex2dec({'7e' 'b9'}), 'unicode')  native2unicode(hex2dec({'53' '3a'}), 'unicode')  native2unicode(hex2dec({'57' 'df'}), 'unicode')  native2unicode(hex2dec({'63' 'a2'}), 'unicode')  native2unicode(hex2dec({'94' '88'}), 'unicode') ' 79']);
model.component('comp1').probe('var1').set('probename', 'var79');
model.component('comp1').probe('var1').set('expr', 'V79');
model.component('comp1').probe('var1').set('unit', 'mm');
model.component('comp1').probe('var1').set('descr', 'V79');
...
model.study('std1').feature('time').set('tlist', 'range(0,0.1,8)');
...
model.sol('sol1').feature('v1').set('clist', {'range(0,0.1,8)' '0.008[s]'});
...
model.sol('sol1').feature('t1').set('tlist', 'range(0,0.1,8)');
...
model.result('pg11').feature('surf1').set('rangecolormin', 0.1);
model.result('pg11').feature('surf1').set('rangecolormax', 0.100025);
...
model.result('pg10').set('ylabel', 'V79 (mm)');
